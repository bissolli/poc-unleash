...
const flag = "alpha-experimentation";
...
onMounted(() => {
  mixpanel.track("Started alpha experimentation");
});
</script>
...
<template>
  ...
  <div v-if="currentStep === 1">
    <button class="button" @click.prevent="moveToStep(2)">Button A</button>
  </div>
  <div v-if="currentStep === 2">
    <button
      class="button"
      @click.prevent="moveToStep(3)"
